...
participate in. This variable is shown in Figure~\ref{fig:up_density}.
...
variable is shown in Figure~\ref{fig:aprr_density}.
...
later point in our data set, and Figure~\ref{fig:up_repeaters_10} shows the
